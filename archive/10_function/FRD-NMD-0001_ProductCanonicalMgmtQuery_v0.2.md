...
- Option Contract: all 5 columns; contract format: YYYYMM_C/P_NN.NN | YYYYMMDD_C/P_NN.NN | YYYYMMWN_C/P_NN.NN | Must | FR-001 | All 6 Futures & Options entity types are representable in the canonical table; contract format validated per entity type on create/update; Product Type values restricted to the defined set; canonical key hash computed with null placeholders for unpopulated columns |
...
| BRL-010 | A canonical record's entity type must match one of the predefined entity types for its asset class — records with invalid column population patterns or contract formats are rejected on create/update | FR-NMD-001-015 |
...
| EX-007 | Create or update attempted with contract format not matching the entity type's permitted formats | Reject; return validation error specifying permitted formats for the entity type; do not persist |
| EX-008 | Create or update attempted with Product Type value not in the defined set for the asset class | Reject; return validation error listing permitted Product Type values; do not persist |
...
|----------------|------------------|------------|
| FR-001 | FR-NMD-001-001, FR-NMD-001-002, FR-NMD-001-003, FR-NMD-001-004, FR-NMD-001-005, FR-NMD-001-006, FR-NMD-001-007, FR-NMD-001-008, FR-NMD-001-009, FR-NMD-001-010, FR-NMD-001-011, FR-NMD-001-012, FR-NMD-001-013, FR-NMD-001-014, FR-NMD-001-015 | PSD, DC, UT |
...
| AC-012 | Contract format validated per entity type — invalid formats rejected on create/update (EX-007) |
